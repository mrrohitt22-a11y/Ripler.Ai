    ...
    <div className="min-h-screen bg-[#F8F9FF] text-[#1A1A2E] py-12 px-6">
      <div className="max-w-3xl mx-auto bg-white p-8 sm:p-12 rounded-2xl shadow-sm border border-[#E8EAF0]">
        ...
        <div className="space-y-5 text-[0.95rem] leading-relaxed text-[#5C5F77]">
          ...
          <p>We want you to be completely satisfied with ResumeAI and the resumes you create.</p>
          ...
          <p>To request a refund, please send an email to <strong>billing@resumeai.in</strong> with your account email address and brief feedback on why you are dissatisfied. We will process your return within 5-7 business days.</p>
