      ...
      <div className={`relative w-full max-w-[400px] h-full sm:h-[800px] sm:max-h-[92vh] sm:rounded-[45px] overflow-hidden shadow-2xl flex flex-col transform transition-all duration-500 ease-out origin-bottom ${isOpen ? 'translate-y-0 scale-100 opacity-100' : 'translate-y-20 scale-95 opacity-0'}`}
        ...
        <div className="flex-1 w-full bg-white/70 backdrop-blur-3xl border-t border-white/50 sm:rounded-t-[45px] px-8 pt-10 pb-8 flex flex-col shadow-[0_-10px_40px_rgba(0,0,0,0.05)] overflow-y-auto scrollbar-hide">
          ...
          <div className="flex justify-center gap-6 mb-10">
            <button className="w-11 h-11 rounded-full bg-[#1877F2] flex items-center justify-center text-white shadow-md hover:-translate-y-1 transition-transform">
              <svg width="22" height="22" fill="currentColor" viewBox="0 0 24 24"><path d="M22 12c0-5.52-4.48-10-10-10S2 6.48 2 12c0 4.84 3.44 8.87 8 9.8V15H7.6v-3h2.4V9.81C10 7.4 11.46 6.1 13.68 6.1c1.03 0 2.11.18 2.11.18v2.32h-1.19c-1.17 0-1.54.73-1.54 1.48V12h2.61l-.42 3h-2.19v6.8C18.56 20.87 22 16.84 22 12z"/></svg>
            </button>
            ...
            <button className="w-11 h-11 rounded-full bg-black flex items-center justify-center text-white shadow-md hover:-translate-y-1 transition-transform">
              <svg width="22" height="22" fill="currentColor" viewBox="0 0 24 24"><path d="M17.05 20.28c-.98.95-2.05.8-3.08.35-1.09-.46-2.09-.48-3.24 0-1.44.62-2.2.44-3.06-.35C2.79 15.25 3.51 7.59 9.05 7.31c1.35.07 2.29.74 3.08.8 1.18-.19 2.24-.86 3.64-.86 1.57.17 2.8.76 3.68 1.83-3.15 1.76-2.63 5.86.32 7.02-.69 1.7-1.57 3.31-2.72 4.18zM12.03 7.25c-.15-2.23 1.66-4.07 3.74-4.25.33 2.51-2.12 4.47-3.74 4.25z"/></svg>
            </button>
          </div>
